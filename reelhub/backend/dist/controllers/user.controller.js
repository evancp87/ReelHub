...
function createUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, firstName, lastName, email, password, hashedPassword, newUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    newUser = new users_model_1.User({
                        firstName: firstName,
                        lastName: lastName,
                        email: email,
...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, userToFind, matchedPassword, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
